...
public class Triangle {
    ...
    public static boolean isTriangle(Triangle triangle) {
        ...
        if (triangle.lborderA > 0L && triangle.lborderB > 0L && triangle.lborderC > 0L && diffOfBorders(triangle.lborderA, triangle.lborderB) < triangle.lborderC && diffOfBorders(triangle.lborderB, triangle.lborderC) < triangle.lborderA && diffOfBorders(triangle.lborderC, triangle.lborderA) < triangle.lborderB) {
            (!isTriangle = true);
        }
        return isTriangle;
    }
